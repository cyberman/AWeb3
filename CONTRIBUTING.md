...
This project is based on AWeb, which is licensed under the [AWeb Public License](./LICENSE.md). To keep contributions legally clear and consistent, please read the following before submitting code.

## Licensing and Copyright

- By submitting a pull request, you agree that your contribution is licensed under the AWeb Public License (APL).  
- **Contributions** of any size - large (new features, modules, significant bug fixes) or small (e.g. typo fixes, formatting, trivial refactors, one-liner changes):
...
- Do **not** submit code you do not have the right to contribute. In particular:
  - **Copyleft code (GPL, LGPL, AGPL, etc.)**:  
    - Cannot be merged directly into the APL-licensed codebase.  
  ...
  - All other contributions must be compatible with the APL license. If in doubt, open an issue before submitting.  
...
It is optional to use the [Developer Certificate of Origin](https://developercertificate.org/).  
By signing off your commits, you certify that you wrote the code or otherwise have the right to submit it under the APL license, and that contributions are made with no copyright retained.
